...
using static myappwebapi.Features.WhoAmI.WhoAmI;
using static myappwebapi.Features.Participant.Agency;
using static myappwebapi.Features.Participant.Application;

namespace myappwebapi.Data;
public class myappwebapiDataContext : DbContext
{
    private readonly IClock clock;

    public myappwebapiDataContext(DbContextOptions<myappwebapiDataContext> options, IClock clock) : base(options) => this.clock = clock;
...
public override int SaveChanges()
   ...
   .HasKey("agencyassignmentid");
    ...
    modelBuilder.ApplyConfigurationsFromAssembly(typeof(myappwebapiDataContext).Assembly);
