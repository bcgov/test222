namespace myappwebapi.Infrastructure.Auth;
...
using myappwebapi.Exceptions;
using myappwebapi.Extensions;

public static class AuthenticationSetup
{
    public static IServiceCollection AddKeycloakAuth(this IServiceCollection services, myappwebapiConfiguration config)
    {
        ...
        .AddJwtBearer(options =>
        {
            ...
            options.Audience = config.Keycloak.myappwebapiClientId;
            options.MetadataAddress = config.Keycloak.WellKnownConfig;

            options.RequireHttpsMetadata = !myappwebapiConfiguration.IsDevelopment();
            options.Events = new JwtBearerEvents
            {
                OnTokenValidated = async context => await OnTokenValidatedAsync(context, config.Keycloak.myappwebapiClientId),
