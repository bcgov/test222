...
using myappwebapi.Infrastructure.HttpClients.Keycloak;



public static class HttpClientSetup
{
    public static IServiceCollection AddHttpClients(this IServiceCollection services, myappwebapiConfiguration config)
    {
